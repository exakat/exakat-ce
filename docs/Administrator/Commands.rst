...
In case the upgrade command file, you may also download manually the `.phar` from the exakat.io website : `www.exakat.io <https://www.exakat.io/versions/>`_. Then replace the current version with the new one.
