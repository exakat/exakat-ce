...
class Php80 extends Php {
    ...
    public const T_IS_EQUAL                                         = 287;
    public const T_IS_NOT_EQUAL                                     = 288;
    public const T_IS_IDENTICAL                                     = 289;
    public const T_IS_NOT_IDENTICAL                                 = 290;
    public const T_SPACESHIP                                        = 291;
    public const T_IS_SMALLER_OR_EQUAL                              = 292;
    public const T_IS_GREATER_OR_EQUAL                              = 293;
    public const T_SL                                               = 294;
    public const T_SR                                               = 295;
    public const T_INSTANCEOF                                       = 296;
    ...
    public const T_NAME_FULLY_QUALIFIED                             = 312;
    public const T_NAME_RELATIVE                                    = 313;
    public const T_NAME_QUALIFIED                                   = 314;
    public const T_VARIABLE                                         = 315;
    public const T_INLINE_HTML                                      = 316;
    ...
    public const T_EVAL                                             = 321;
    public const T_NEW                                              = 322;
    public const T_EXIT                                             = 323;
    public const T_IF                                               = 324;
    public const T_ENDIF                                            = 325;
    ...
    public const T_VAR                                              = 361;
    public const T_UNSET                                            = 362;
    public const T_ISSET                                            = 363;
    public const T_EMPTY                                            = 364;
    public const T_HALT_COMPILER                                    = 365;
    public const T_CLASS                                            = 366;
    public const T_TRAIT                                            = 367;
    public const T_INTERFACE                                        = 368;
    public const T_EXTENDS                                          = 369;
    public const T_IMPLEMENTS                                       = 370;
    public const T_NAMESPACE                                        = 371;
    public const T_LIST                                             = 372;
    public const T_ARRAY                                            = 373;
    public const T_CALLABLE                                         = 374;
    public const T_LINE                                             = 375;
    public const T_FILE                                             = 376;
    public const T_DIR                                              = 377;
    public const T_CLASS_C                                          = 378;
    public const T_TRAIT_C                                          = 379;
    public const T_METHOD_C                                         = 380;
    public const T_FUNC_C                                           = 381;
    public const T_NS_C                                             = 382;
    public const T_ATTRIBUTE                                        = 383;
    public const T_INC                                              = 384;
    public const T_DEC                                              = 385;
    public const T_OBJECT_OPERATOR                                  = 386;
    public const T_NULLSAFE_OBJECT_OPERATOR                         = 387;
    public const T_COMMENT                                          = 388;
    public const T_DOC_COMMENT                                      = 389;
    public const T_OPEN_TAG                                         = 390;
    public const T_OPEN_TAG_WITH_ECHO                               = 391;
    public const T_CLOSE_TAG                                        = 392;
    public const T_WHITESPACE                                       = 393;
    public const T_START_HEREDOC                                    = 394;
    public const T_END_HEREDOC                                      = 395;
    public const T_DOLLAR_OPEN_CURLY_BRACES                         = 396;
    public const T_CURLY_OPEN                                       = 397;
    public const T_PAAMAYIM_NEKUDOTAYIM                             = 398;
    public const T_NS_SEPARATOR                                     = 399;
