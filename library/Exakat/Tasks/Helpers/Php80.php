...
class Php80 extends Php {
    ...
    public const T_DOUBLE_ARROW                                     = 384;
    public const T_YIELD_FROM                                       = 282;
    public const T_PLUS_EQUAL                                       = 350;
    public const T_MINUS_EQUAL                                      = 351;
    public const T_MUL_EQUAL                                        = 352;
    public const T_DIV_EQUAL                                        = 353;
    public const T_CONCAT_EQUAL                                     = 354;
    public const T_MOD_EQUAL                                        = 355;
    public const T_AND_EQUAL                                        = 356;
    public const T_OR_EQUAL                                         = 357;
    public const T_XOR_EQUAL                                        = 358;
    public const T_SL_EQUAL                                         = 359;
    public const T_SR_EQUAL                                         = 360;
    public const T_POW_EQUAL                                        = 400;
    public const T_COALESCE_EQUAL                                   = 361;
    public const T_COALESCE                                         = 398;
    public const T_BOOLEAN_OR                                       = 362;
    public const T_BOOLEAN_AND                                      = 363;
    public const T_IS_EQUAL                                         = 364;
    public const T_IS_NOT_EQUAL                                     = 365;
    public const T_IS_IDENTICAL                                     = 366;
    public const T_IS_NOT_IDENTICAL                                 = 367;
    public const T_SPACESHIP                                        = 370;
    public const T_IS_SMALLER_OR_EQUAL                              = 368;
    public const T_IS_GREATER_OR_EQUAL                              = 369;
    public const T_SL                                               = 371;
    public const T_SR                                               = 372;
    public const T_INSTANCEOF                                       = 283;
    public const T_INT_CAST                                         = 375;
    public const T_DOUBLE_CAST                                      = 376;
    public const T_STRING_CAST                                      = 377;
    public const T_ARRAY_CAST                                       = 378;
    public const T_OBJECT_CAST                                      = 379;
    public const T_BOOL_CAST                                        = 380;
    public const T_UNSET_CAST                                       = 381;
    public const T_POW                                              = 399;
    ...
    public const T_VAR                                              = 327;
    public const T_UNSET                                            = 328;
    public const T_ISSET                                            = 329;
    public const T_EMPTY                                            = 330;
    public const T_HALT_COMPILER                                    = 331;
    public const T_CLASS                                            = 332;
    public const T_TRAIT                                            = 333;
    public const T_INTERFACE                                        = 334;
    public const T_EXTENDS                                          = 335;
    public const T_IMPLEMENTS                                       = 336;
    public const T_NAMESPACE                                        = 337;
    public const T_LIST                                             = 338;
    public const T_ARRAY                                            = 339;
    public const T_CALLABLE                                         = 340;
    public const T_LINE                                             = 341;
    public const T_FILE                                             = 342;
    public const T_DIR                                              = 343;
    public const T_CLASS_C                                          = 344;
    public const T_TRAIT_C                                          = 345;
    public const T_METHOD_C                                         = 346;
    public const T_FUNC_C                                           = 347;
    public const T_NS_C                                             = 348;
    public const T_ATTRIBUTE                                        = 349;
    public const T_INC                                              = 373;
    public const T_DEC                                              = 374;
    public const T_OBJECT_OPERATOR                                  = 382;
    public const T_NULLSAFE_OBJECT_OPERATOR                         = 383;
    public const T_COMMENT                                          = 385;
    public const T_DOC_COMMENT                                      = 386;
    public const T_OPEN_TAG                                         = 387;
    public const T_OPEN_TAG_WITH_ECHO                               = 388;
    public const T_CLOSE_TAG                                        = 389;
    public const T_WHITESPACE                                       = 390;
    public const T_START_HEREDOC                                    = 391;
    public const T_END_HEREDOC                                      = 392;
    public const T_DOLLAR_OPEN_CURLY_BRACES                         = 393;
    public const T_CURLY_OPEN                                       = 394;
    public const T_PAAMAYIM_NEKUDOTAYIM                             = 395;
    public const T_NS_SEPARATOR                                     = 396;
    public const T_ELLIPSIS                                         = 397;
    public const T_BAD_CHARACTER                                    = 401;
    public const T_DOUBLE_COLON                                     = 395;
